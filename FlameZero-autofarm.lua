...
spawn(function()
    while true do 
        pcall(function()
            if farm then
                if player.PlayerFolder.QuestProgress.Value == player.PlayerFolder.QuestMax.Value or player.PlayerFolder.QuestProgress.Value == 0 and player.PlayerFolder.QuestMax.Value == 0 then
